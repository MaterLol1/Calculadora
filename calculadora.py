...
def click_boton(valor):
    global a
    if valor == 'x':
        valor = '*'  # Reemplaza 'x' por el operador de multiplicación '*'
    entrada_texto.insert(a, valor)
    a += 1
...
def realizar_operacion():
    ...
    entrada_texto.insert(0, resultado)
    a = 0
#Botones (no estan agregados a la pantalla)
...
#Botones agregados a la interfaz (Posicionarlos)
